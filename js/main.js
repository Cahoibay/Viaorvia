...
const sendEmail = (e)=>{
    ...
    if(contactName.value === '' || contactEmail.value === '' || contactProject.value === '')
    {
        ...
        //show message
        contactMessage.textContent = "Input all the field!";
    }else
    {
        emailjs.sendForm('service_pn7pvyl', 'template_qne3yc2', '#contact-form', 'ckqBL_hB_hDD3aL1u')
            .then(() => {
        ...
        //Clear the input field after sent
        contactName.value = ''
        contactEmail.value = ''
...
sr.reveal(`.home__info div`,{ delay:600, origin:'bottom'})
